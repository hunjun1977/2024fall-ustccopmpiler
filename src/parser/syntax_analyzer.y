...
expression-stmt : expression ; {$$ = node("expression-stmt",2,$1,$2);}| ; {{ $$ = node("expression-stmt",1,$1);}}
...
expression : var ASSIGN expression {$$=node("expression",3,$1,$2,$3)} | simple-expression {$$ = node("simple-expression",1,$1)}
